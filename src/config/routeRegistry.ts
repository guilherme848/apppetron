...
export const routeRegistry: RouteDefinition[] = [
  ...
  {
    id: 'content.production_board',
    path: '/content/production/board',
  ...
  {
    id: 'traffic.legacy_tasks',
    path: '/traffic/tasks',
    label: 'Tarefas de Tráfego (Legacy)',
    category: CATEGORIES.TASKS,
    module: MODULES.TRAFFIC,
    permissions: ['view', 'edit'],
    hideInMenu: true,
  ...
  },
  {
    ...
    path: '/cs/onboarding/meeting/:meetingId',
  ...
  {
    id: 'rh.job_kanban',
    path: '/rh/vagas/:id/kanban',
    label: 'Kanban da Vaga',
    category: CATEGORIES.PRODUCTION,
    module: MODULES.RH,
    permissions: ['view', 'edit'],
    hideInMenu: true,
