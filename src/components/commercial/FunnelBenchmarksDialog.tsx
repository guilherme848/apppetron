          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-center text-red-600">Ruim</TableHead>
                <TableHead className="text-center text-amber-600">Regular</TableHead>
                <TableHead className="text-center text-green-600">Bom</TableHead>
