...
const TrafficCreativeRedirect = lazy(() => import("./pages/traffic/TrafficCreativeRedirect"));
...
const HrEvalPreview = lazy(() => import("./pages/public/HrEvalPreview"));
                ...
                <ContentProductionProvider>
                  <TrafficProvider>
                    ...
                    <Routes>
                      ...
                      <Route path="/preview/hr-eval" element={<HrEvalPreview />} />
                      ...
                      <Route element={<ProtectedAppShell />}>
                        ...
                        <Route path="/traffic/creative" element={<TrafficCreativeRedirect />} />
